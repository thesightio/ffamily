        ...
        <div class="contacts-info flex flex-just-b flex-wrap">
          <div class="col-7">
            ...
            <p>
              ...
              персональных данных FontFamily (далее – Оператор).
            </p>
            <ul>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                <mark for="site">https://fontfamily.ru</mark>;
              </li>
              <li>
              ...
              <li>
                ...
                веб-сайта <mark for="site">http://fontfamily.ru</mark>;
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                электронной почты help@fontfamily.ru с пометкой «Отказ от
            ...
            <ul>
              <li>
                ...
                https://fontfamily.ru. Заполняя соответствующие формы и/или
            ...
            <ul>
              ...
              <li>
                ...
                Оператора help@fontfamily.ru с пометкой «Актуализация
                персональных данных».
              </li>
              <li>
                ...
                help@fontfamily.ru с пометкой «Отзыв согласия на обработку
                персональных данных».
              </li>
            </ul>
            ...
            <ul>
              ...
              <li>
                ...
                сети Интернет по адресу https://fontfamily.ru/policy.
              </li>
            </ul>
          </div>
        </div>
